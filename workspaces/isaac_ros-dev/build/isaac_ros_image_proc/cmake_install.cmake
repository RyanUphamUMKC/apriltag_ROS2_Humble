...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/share/isaac_ros_image_proc/gxf/lib/image_proc/libgxf_rectify_params_generator.so" AND
    ...
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/share/isaac_ros_image_proc/gxf/lib/image_proc/libgxf_rectify_params_generator.so"
         OLD_RPATH "/workspaces/isaac_ros-dev/install/isaac_ros_gxf/share/isaac_ros_gxf/gxf/lib/multimedia:/workspaces/isaac_ros-dev/install/isaac_ros_gxf/share/isaac_ros_gxf/gxf/lib:"
         NEW_RPATH "")
    if(CMAKE_INSTALL_DO_STRIP)
